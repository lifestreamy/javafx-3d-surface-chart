...
public class Triangle implements Serializable {
    ...
    public BoundingBox getBoundingBox() {
        ...
        lowerLeft = new Point(Math.min(a.getX(), Math.min(b.getX(), c.getX())), Math
                .min(a.getY(), Math.min(b.getY(), c.getY())));
        upperRight = new Point(Math.max(a.getX(), Math.max(b.getX(), c.getX())), Math
                .max(a.getY(), Math.max(b.getY(), c.getY())));
    ...
    Triangle nextNeighbor(Point p, Triangle prevTriangle) {
        ...
        if (Objects.requireNonNull(neighbor).equals(prevTriangle) || neighbor.isHalfplane()) {
            if (a.equals(p)) {
                neighbor = abTriangle;
            }
            if (b.equals(p)) {
    ...
    Circle circumcircle() {
        ...
        double u =
                ((a.getX() - b.getX()) * (a.getX() + b.getX()) + (a.getY() - b.getY()) * (a.getY() + b.getY())) / 2.0f;
        double v =
                ((b.getX() - c.getX()) * (b.getX() + c.getX()) + (b.getY() - c.getY()) * (b.getY() + c.getY())) / 2.0f;
        ...
        if (den == 0.0) // oops, degenerate case
            ...
            Point cen = new Point((u * (b.getY() - c.getY()) - v * (a.getY() - b.getY())) / den, (v * (a.getX() - b
                    .getX()) - u
                    * (b.getX() - c.getX()))
                    / den);
    ...
    public double zValue(Point q) {
         ...
         */
        double X, x0 = q.getX(), x1 = a.getX(), x2 = b.getX(), x3 = c.getX();
        double Y, y0 = q.getY(), y1 = a.getY(), y2 = b.getY(), y3 = c.getY();
        double Z, m01 = 0, k01 = 0, m23 = 0, k23 = 0;
